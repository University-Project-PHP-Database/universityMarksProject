...
<?php
	...
	if(isset($_POST['xid']) && !empty($_POST['xid']))
	{
		$tabQuery[]="xid='".$_POST['xid']."'";
		$addWhere++;
	}
	if(isset($_POST['xlabel']) && !empty($_POST['xlabel']))
	{
		$tabQuery[]="xlabel='".$_POST['xlabel']."'";
		$addWhere++;
	}
...
<?php
        ...
        echo "<h2>There is no record for this exam!</h2>";
    }
...
<p class="positioning-body">
                <a href="exams-view-page.php">Back</a>
|               <a href="logout.php">Logout</a></p>
